...
},{"./modules/form-validate/form":3,"./modules/modals/init-modals":9,"./utils/header-nav":12,"./utils/ios-vh-fix":14,"./utils/no-js":15}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":11,"../../utils/scroll-lock":16}],11:[function(require,module,exports){
"use strict";
...
var header = document.querySelector('.header');
var nav = document.querySelector('.nav');
var contacts = document.querySelector('.contacts__map');
if (header) {
